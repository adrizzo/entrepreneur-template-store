      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            ...
            <span className="block text-yellow-400">Innovative Entrepreneurs</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-blue-100">
            Shop unique, high-quality products created by passionate entrepreneurs. 
            Support innovation and find products you won&apos;t see anywhere else.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Safe and secure payment processing with industry-leading encryption.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Quick and reliable shipping options to get your products fast.
              </p>
            </div>
          </div>
        </div>
